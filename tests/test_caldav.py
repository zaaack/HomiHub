...
KNOWN_DEVIATIONS = {
    ...
    "search.is-not-defined.dtend": "is-not-defined prop-filter not implemented",
    ...
    "search.recurrences.includes-implicit.todo": "implicit recurrence instances for VTODO not generated",
